...
export const SYMBOLS = [
  ...
  { label: '\\arcsin', value: '\\arcsin', tooltip: 'Arc-Sine' },
  { label: '\\arccos', value: '\\arccos', tooltip: 'Arc-Cosine' },
  { label: '\\arctan', value: '\\arctan', tooltip: 'Arc-Tangent' },
  ...
  // Misc
  { label: '^{\\circ}', value: '^{\\circ}', tooltip: 'Degree', isComplex: true },
